...
{
  new (message_memory) sfm_ros2::msg::MapGraph(_init);
}

void MapGraph_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sfm_ros2::msg::MapGraph *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<sfm_ros2::msg::Link> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<sfm_ros2::msg::Link> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<sfm_ros2::msg::Link> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__MapGraph__links(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const sfm_ros2::msg::Link *>(
    get_const_function__MapGraph__links(untyped_member, index));
  auto & value = *reinterpret_cast<sfm_ros2::msg::Link *>(untyped_value);
  value = item;
}
...
void assign_function__MapGraph__links(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<sfm_ros2::msg::Link *>(
    get_function__MapGraph__links(untyped_member, index));
  const auto & value = *reinterpret_cast<const sfm_ros2::msg::Link *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MapGraph_message_member_array[5] = {
  {
    ...
    offsetof(sfm_ros2::msg::MapGraph, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sfm_ros2::msg::MapGraph, map_to_odom),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sfm_ros2::msg::MapGraph, poses_id),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sfm_ros2::msg::MapGraph, poses),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<sfm_ros2::msg::Link>(),  // members of sub message
    false,  // is key
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(sfm_ros2::msg::MapGraph, links),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MapGraph_message_members = {
  "sfm_ros2::msg",  // message namespace
  "MapGraph",  // message name
  5,  // number of fields
  sizeof(sfm_ros2::msg::MapGraph),
...
get_message_type_support_handle<sfm_ros2::msg::MapGraph>()
{
  return &::sfm_ros2::msg::rosidl_typesupport_introspection_cpp::MapGraph_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sfm_ros2, msg, MapGraph)() {
  return &::sfm_ros2::msg::rosidl_typesupport_introspection_cpp::MapGraph_message_type_support_handle;
}
