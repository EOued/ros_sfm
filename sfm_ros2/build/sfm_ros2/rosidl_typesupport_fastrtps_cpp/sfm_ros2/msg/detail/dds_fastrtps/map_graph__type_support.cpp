...
#include "sfm_ros2/msg/detail/map_graph__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sfm_ros2
cdr_serialize(
  const sfm_ros2::msg::MapGraph & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: links
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      sfm_ros2::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.links[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sfm_ros2::msg::MapGraph & ros_message)
{
  // Member: header
  ...
  // Member: links
  {
    ...
    for (size_t i = 0; i < size; i++) {
      sfm_ros2::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: links
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        sfm_ros2::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: links
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sfm_ros2::msg::typesupport_fastrtps_cpp::max_serialized_size_Link(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = sfm_ros2::msg::MapGraph;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: links
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      sfm_ros2::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.links[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: links
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        sfm_ros2::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.links[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: links
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sfm_ros2::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Link(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const sfm_ros2::msg::MapGraph *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sfm_ros2::msg::MapGraph *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_sfm_ros2
const rosidl_message_type_support_t *
get_message_type_support_handle<sfm_ros2::msg::MapGraph>()
{
  return &sfm_ros2::msg::typesupport_fastrtps_cpp::_MapGraph__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sfm_ros2, msg, MapGraph)() {
  return &sfm_ros2::msg::typesupport_fastrtps_cpp::_MapGraph__handle;
}
