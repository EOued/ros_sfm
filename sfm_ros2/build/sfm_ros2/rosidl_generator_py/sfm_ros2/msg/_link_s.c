...
bool sfm_ros2__msg__link__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sfm_ros2.msg._link.Link", full_classname_dest, 23) == 0);
  }
  sfm_ros2__msg__Link * ros_message = _ros_message;
  {  // from_id
...
PyObject * sfm_ros2__msg__link__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sfm_ros2.msg._link");
