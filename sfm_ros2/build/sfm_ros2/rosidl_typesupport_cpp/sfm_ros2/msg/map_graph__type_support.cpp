...
static const _MapGraph_type_support_symbol_names_t _MapGraph_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sfm_ros2, msg, MapGraph)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sfm_ros2, msg, MapGraph)),
  }
};
...
{
  return &::sfm_ros2::msg::rosidl_typesupport_cpp::MapGraph_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sfm_ros2, msg, MapGraph)() {
  return get_message_type_support_handle<sfm_ros2::msg::MapGraph>();
}
