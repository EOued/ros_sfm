...
static char sfm_ros2__msg__Link__FIELD_NAME__from_id[] = "from_id";
static char sfm_ros2__msg__Link__FIELD_NAME__to_id[] = "to_id";
static char sfm_ros2__msg__Link__FIELD_NAME__type[] = "type";
static char sfm_ros2__msg__Link__FIELD_NAME__transform[] = "transform";
static char sfm_ros2__msg__Link__FIELD_NAME__information[] = "information";

static rosidl_runtime_c__type_description__Field sfm_ros2__msg__Link__FIELDS[] = {
  {
    {sfm_ros2__msg__Link__FIELD_NAME__from_id, 7, 7},
    {
  ...
  {
    {sfm_ros2__msg__Link__FIELD_NAME__to_id, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_INT32,
      0,
      0,
  ...
  {
    {sfm_ros2__msg__Link__FIELD_NAME__type, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_INT32,
      0,
      0,
  ...
  {
    {sfm_ros2__msg__Link__FIELD_NAME__transform, 9, 9},
    {
  ...
  {
    {sfm_ros2__msg__Link__FIELD_NAME__information, 11, 11},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription sfm_ros2__msg__Link__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {sfm_ros2__msg__Link__FIELDS, 5, 5},
    },
    {sfm_ros2__msg__Link__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
sfm_ros2__msg__Link__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *sfm_ros2__msg__Link__get_individual_type_description_source(NULL),
