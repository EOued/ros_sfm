...
ROSIDL_GENERATOR_C_PUBLIC_sfm_ros2
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x62, 0x61, 0x14, 0xd1, 0xf9, 0x19, 0x2c, 0xde,
      0xb1, 0xc9, 0x36, 0xa6, 0x73, 0x70, 0x4b, 0x41,
      0xfe, 0x0b, 0x13, 0x34, 0xc6, 0xaf, 0x92, 0x87,
      0xc0, 0x3c, 0xcd, 0xf2, 0x4f, 0x90, 0x3b, 0x7a,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t sfm_ros2__msg__Link__EXPECTED_HASH = {1, {
    0x36, 0x75, 0xde, 0xb1, 0x2f, 0xba, 0x70, 0x64,
    0x2c, 0x96, 0xd0, 0x4a, 0x36, 0xeb, 0xab, 0xeb,
    0x15, 0xe4, 0xc0, 0x13, 0x94, 0x9e, 0xd2, 0xbf,
    0x03, 0x3f, 0x89, 0x3e, 0xf4, 0x95, 0xce, 0x96,
  }};
...
static char sfm_ros2__msg__MapGraph__TYPE_NAME[] = "sfm_ros2/msg/MapGraph";
...
static char sfm_ros2__msg__Link__TYPE_NAME[] = "sfm_ros2/msg/Link";
static char std_msgs__msg__Header__TYPE_NAME[] = "std_msgs/msg/Header";

// Define type names, field names, and default values
static char sfm_ros2__msg__MapGraph__FIELD_NAME__header[] = "header";
static char sfm_ros2__msg__MapGraph__FIELD_NAME__map_to_odom[] = "map_to_odom";
static char sfm_ros2__msg__MapGraph__FIELD_NAME__poses_id[] = "poses_id";
static char sfm_ros2__msg__MapGraph__FIELD_NAME__poses[] = "poses";
static char sfm_ros2__msg__MapGraph__FIELD_NAME__links[] = "links";

static rosidl_runtime_c__type_description__Field sfm_ros2__msg__MapGraph__FIELDS[] = {
  {
    {sfm_ros2__msg__MapGraph__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {sfm_ros2__msg__MapGraph__FIELD_NAME__map_to_odom, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {sfm_ros2__msg__MapGraph__FIELD_NAME__poses_id, 8, 8},
    {
  ...
  {
    {sfm_ros2__msg__MapGraph__FIELD_NAME__poses, 5, 5},
    {
  ...
  {
    {sfm_ros2__msg__MapGraph__FIELD_NAME__links, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
      {sfm_ros2__msg__Link__TYPE_NAME, 17, 17},
    },
    {NULL, 0, 0},
  },
};

static rosidl_runtime_c__type_description__IndividualTypeDescription sfm_ros2__msg__MapGraph__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {sfm_ros2__msg__MapGraph__TYPE_NAME, 21, 21},
      {sfm_ros2__msg__MapGraph__FIELDS, 5, 5},
    },
    {sfm_ros2__msg__MapGraph__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&sfm_ros2__msg__Link__EXPECTED_HASH, sfm_ros2__msg__Link__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[7].fields = sfm_ros2__msg__Link__get_type_description(NULL)->type_description.fields;
...
sfm_ros2__msg__MapGraph__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *sfm_ros2__msg__MapGraph__get_individual_type_description_source(NULL),
    ...
    sources[8] = *sfm_ros2__msg__Link__get_individual_type_description_source(NULL);
